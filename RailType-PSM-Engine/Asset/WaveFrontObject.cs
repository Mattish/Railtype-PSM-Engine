...
namespace RailTypePSMEngine.Asset{
    ...
    public class WaveFrontObject{
        private List<Vector3> pos, uv, normal;
        private List<string> lines;
        public List<Model> models;
        private List<Vertex> vertexList;
        private Dictionary<string, ushort> vertexDict;
        ...
        public WaveFrontObject(string path){
                    ...
                    case 'v': // Vertex
                        switch (lines[i][1]){
                            case 't': // UV
                                ...
                                if (tmpStrings.Length > 3) tmpVector3.Z = float.Parse(tmpStrings[3]);
                                uv.Add(tmpVector3);
                                break;
                            case 'n': // Normal
                                tmpVector3.X = float.Parse(tmpStrings[1]);
            ...
            foreach (Model m in models) m.finalize();
        }
